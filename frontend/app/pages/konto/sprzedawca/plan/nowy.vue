      ...
      <div class="flex flex-col gap-8">
        ...
        <div class="flex flex-col gap-4">
          ...
          >
            ...
            />
            <p class="text-sm text-muted">Brak rzutów kondygnacji.</p>
          </div>
          ...
          <div class="space-y-0">
            ...
            >
              <div class="flex items-center gap-2 text-muted">
                ...
                <span class="text-sm"
                  >Powierzchnia użytkowa <span class="text-error">*</span></span
                >
              </div>
            ...
            >
              <div class="flex items-center gap-2 text-muted">
                ...
                <span class="text-sm"
                  >Liczba pokoi <span class="text-error">*</span></span
                >
              </div>
              <UInput
                v-model="form.rooms"
            ...
            >
              <div class="flex items-center gap-2 text-muted">
                ...
                <span class="text-sm"
                  >Łazienki i WC <span class="text-error">*</span></span
                >
              </div>
              <UInput
            ...
            >
              <div class="flex items-center gap-2 text-muted">
                ...
                <span class="text-sm"
                  >Min. wymiary działki <span class="text-error">*</span></span
                >
              </div>
              <UInput
    ...
    <div v-show="activeTab === 'galeria'">
      <div class="flex items-center justify-between mb-6">
        ...
        <label class="cursor-pointer">
          ...
          />
          <UButton as="span" icon="i-lucide-image-plus" size="sm"
    ...
    <div v-show="activeTab === 'pliki'">
      <div class="flex items-center justify-between mb-6">
        ...
        <label class="cursor-pointer">
          ...
          />
          <UButton as="span" icon="i-lucide-upload" size="sm"
            >Wgraj pliki</UButton
          >
        </label>
      </div>
